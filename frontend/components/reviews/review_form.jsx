...
class ReviewForm extends React.Component {
    ...
    render() {
      ...
      if (this.props.loggedIn) {
          saveButton = <button className="btn btn-success btn-lg" type="submit" style={{width:"100%"}}>Leave a Review</button>;
      } else {
          saveButton = <button className="btn btn-success btn-green" type="submit" disabled={true} style={{width:"100%"}}>Leave a Review</button>;
      }
